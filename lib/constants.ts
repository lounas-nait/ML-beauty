// Site Metadata
export const SITE_NAME = 'MLbeauty';
export const SITE_DESCRIPTION = 'Service de prothésiste ongulaire à domicile - Paris et alentours';
export const SITE_URL = 'https://nails-beauty.com';
...
export const SERVICE_CITY = 'Paris';

// Social Media
export const INSTAGRAM_HANDLE = '@nails_beauty_paris';
...
export const STATS = [
  ...
  { number: '5/5', label: 'Avis clients' },
  { number: '4 ans', label: 'D\'expérience' },
];
